...
chmod +x /tmp/xlm
/tmp/xlm install-steam-tool --extra-launch-args="--xlcore-web-release-url-base=\"https://github.com/rankynbass/XIVLauncher.Core/releases/download/rb-v1.2.1.1-beta/\"" --steam-compat-path ~/.steam/root/compatibilitytools.d/
