...
chmod +x /tmp/xlm
mkdir -p /tmp/xlm-rb
/tmp/xlm install-steam-tool --extra-launch-args="--use-fallback-secret-provider --xlcore-web-release-url-base=\"https://github.com/rankynbass/XIVLauncher.Core/releases/download/rb-v1.3.1.1-beta1/\"" --steam-compat-path /tmp/xlm-rb
