...
#!/bin/bash
$HOME/.local/share/xivlauncher-rb/xlm launch --install-directory ~/.local/share/xivlauncher-rb/xlcore --xlcore-web-release-url-base="https://github.com/rankynbass/XIVLauncher.Core/releases/download/rb-v1.2.1.1-beta6/"
EOL
