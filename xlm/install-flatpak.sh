...
chmod +x /tmp/xlm
/tmp/xlm install-steam-tool --extra-launch-args="--use-fallback-secret-provider --xlcore-repo-owner rankynbass" --steam-compat-path ~/.var/app/com.valvesoftware.Steam/.local/share/Steam/compatibilitytools.d/
