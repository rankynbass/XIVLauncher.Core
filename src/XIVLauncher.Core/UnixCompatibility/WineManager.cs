...
{
    [SettingsDescription("Wine-xiv 8.5", "A patched version of Wine-staging 8.5. The default for 1.0.4.")]
    Wine8_5,

    [SettingsDescription("Wine-xiv 7.10", "A legacy patched version of Wine, based on 7.10. The default for 1.0.3.")]
    Wine7_10,
}
...
public static class WineManager
{
    public static WineSettings GetSettings()
    {
        ...
        switch (Program.Config.WineStartupType ?? WineStartupType.Managed)
        {
            ...
            default:
                throw new ArgumentOutOfRangeException("Bad value for WineStartupType");
        }
