...
public class StyleModelV1 : StyleModel
{
    ...
    public static StyleModelV1 DalamudStandard => new()
    {
        ...
        Alpha = 1,
        WindowPadding = new Vector2(8, 8) * ImGuiHelpers.GlobalScale,
        WindowRounding = 4 * ImGuiHelpers.GlobalScale,
        WindowBorderSize = 0,
        WindowTitleAlign = new Vector2(0, 0.5f),
        WindowMenuButtonPosition = ImGuiDir.Right,
        ChildRounding = 0,
        ChildBorderSize = 1 * ImGuiHelpers.GlobalScale,
        PopupRounding = 0,
        PopupBorderSize = 0,
        FramePadding = new Vector2(4, 3) * ImGuiHelpers.GlobalScale,
        //FrameRounding = 4,
        FrameRounding = 0,
        FrameBorderSize = 0,
        ItemSpacing = new Vector2(8, 4) * ImGuiHelpers.GlobalScale,
        ItemInnerSpacing = new Vector2(4, 4) * ImGuiHelpers.GlobalScale,
        CellPadding = new Vector2(4, 2) * ImGuiHelpers.GlobalScale,
        TouchExtraPadding = new Vector2(0, 0),
        IndentSpacing = 21 * ImGuiHelpers.GlobalScale,
        ScrollbarSize = 16 * ImGuiHelpers.GlobalScale,
        ScrollbarRounding = 9 * ImGuiHelpers.GlobalScale,
        GrabMinSize = 13 * ImGuiHelpers.GlobalScale,
        GrabRounding = 3 * ImGuiHelpers.GlobalScale,
        LogSliderDeadzone = 4 * ImGuiHelpers.GlobalScale,
        TabRounding = 1 * ImGuiHelpers.GlobalScale,
        TabBorderSize = 0,
        ButtonTextAlign = new Vector2(0.5f, 0.5f),
        SelectableTextAlign = new Vector2(0, 0),
        DisplaySafeAreaPadding = new Vector2(3, 3) * ImGuiHelpers.GlobalScale,
    ...
    public static StyleModelV1 DalamudClassic => new()
    {
        ...
        PopupBorderSize = 0,
        FramePadding = new Vector2(4, 3) * ImGuiHelpers.GlobalScale,
        FrameRounding = 4 * ImGuiHelpers.GlobalScale,
        FrameBorderSize = 0,
        ItemSpacing = new Vector2(8, 4) * ImGuiHelpers.GlobalScale,
        ItemInnerSpacing = new Vector2(4, 4) * ImGuiHelpers.GlobalScale,
        CellPadding = new Vector2(4, 2) * ImGuiHelpers.GlobalScale,
        ...
        ScrollbarSize = 16 * ImGuiHelpers.GlobalScale,
        ScrollbarRounding = 9 * ImGuiHelpers.GlobalScale,
        GrabMinSize = 10 * ImGuiHelpers.GlobalScale,
        GrabRounding = 3 * ImGuiHelpers.GlobalScale,
        LogSliderDeadzone = 4 * ImGuiHelpers.GlobalScale,
        TabRounding = 4 * ImGuiHelpers.GlobalScale,
        TabBorderSize = 0,
        ButtonTextAlign = new Vector2(0.5f, 0.5f),
        SelectableTextAlign = new Vector2(0, 0),
        DisplaySafeAreaPadding = new Vector2(3, 3) * ImGuiHelpers.GlobalScale,
