...
public class NewsFrame : Component
{
    ...
    private Vector2 GetSize()
    {
        ...
        var calculatedSize = vp.X >= ImGuiHelpers.ScaleFloat(1280) ? vp.X * 0.7f : vp.X * 0.5f;
        return new Vector2(calculatedSize, vp.Y - ImGuiHelpers.ScaleFloat(128f));
    }
    ...
    public override void Draw()
    {
        if (ImGui.BeginChild("###newsFrame", this.GetSize()))
        {
            ...
            if (this.newsLoaded)
            {
                ...
                ImGui.Image(banner.ImGuiHandle, ImGuiHelpers.ScaleVector2(banner.Size));
