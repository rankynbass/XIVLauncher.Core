...
public class SettingsTabGame : SettingsTab
{
    public override SettingsEntry[] Entries { get; } =
    {
        ...
        new SettingsEntry<string>("Additional Arguments", "Additional args to start the game with (no environment variables)", () => Program.Config.AdditionalArgs, x => Program.Config.AdditionalArgs = x),
