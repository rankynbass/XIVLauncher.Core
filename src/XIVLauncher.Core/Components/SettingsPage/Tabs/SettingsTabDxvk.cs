...
public class SettingsTabDxvk : SettingsTab
{
    ...
    public SettingsTabDxvk()
    {
        Entries = new SettingsEntry[]
        {
            ...
            new SettingsEntry<bool>("Enable VKD3D", "Enable VKD3D, which adds Dx12 support. Might be needed for DLSS", () => Program.Config.Vkd3dEnabled ?? false, b => Program.Config.Vkd3dEnabled = b),
