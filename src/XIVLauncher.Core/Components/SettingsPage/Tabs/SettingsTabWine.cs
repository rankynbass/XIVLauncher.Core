...
public class SettingsTabWine : SettingsTab
{
    ...
    public SettingsTabWine()
    {
        Entries = new SettingsEntry[]
        {
            ...
            new DictionarySettingsEntry("Wine Version", $"Wine versions in {toolDirectory}\nEntries marked with *Download* will be downloaded when you log in.", Wine.Versions, () => Program.Config.WineVersion ?? "wine-xiv-staging-fsync-git-7.10.r3.g560db77d", s => Program.Config.WineVersion = s, Wine.GetDefaultVersion())
            {
