...
public class FtsPage : Page
{
    ...
    public override void Draw()
    {
        ...
        ImGui.Image(this.isSteamDeckAppIdError ? this.steamdeckAppIdErrorTexture.ImGuiHandle : this.steamdeckFtsTexture.ImGuiHandle, ImGuiHelpers.ScaleVector2(1280, 800));

        ImGui.PushStyleColor(ImGuiCol.Button, Vector4.Zero);
        ImGui.PushStyleColor(ImGuiCol.ButtonHovered, Vector4.Zero);
        ImGui.PushStyleColor(ImGuiCol.ButtonActive, Vector4.Zero);

        ImGui.SetCursorPos(ImGuiHelpers.ScaleVector2(316, 481));

        if (ImGui.Button("###openGuideButton", ImGuiHelpers.ScaleVector2(649, 101)))
        {
        ...
        ImGui.SetCursorPos(ImGuiHelpers.ScaleVector2(316, 598));

        if (ImGui.Button("###finishFtsButton", ImGuiHelpers.ScaleVector2(649, 101)) && !this.isSteamDeckAppIdError)
        {
            this.FinishFts(true);
        }
